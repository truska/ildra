...
ALTER TABLE event_types ADD COLUMN IF NOT EXISTS form_profile VARCHAR(32) NOT NULL DEFAULT 'ride';
ALTER TABLE event_types ADD COLUMN IF NOT EXISTS default_attendee_limit INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE events ADD COLUMN IF NOT EXISTS attendee_limit INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE entry_components ADD COLUMN IF NOT EXISTS component_scope VARCHAR(20) NOT NULL DEFAULT 'booking';
