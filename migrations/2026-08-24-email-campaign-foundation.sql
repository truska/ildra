...
CREATE TABLE IF NOT EXISTS email_campaign_templates (
    ...
    category ENUM('operational','general','ride_notice') NOT NULL DEFAULT 'general',
...
VALUES
    ...
    ('membership_renewal', 'Annual Membership Renewal', 'general', 'Membership renewal for {{membership_year}}', '<h2>Membership renewal</h2><p>Hello {{first_name}},</p><p>Membership renewal for {{membership_year}} is now available.</p><p><a href="{{membership_url}}">Renew membership</a></p>', 'Hello {{first_name}},\n\nMembership renewal for {{membership_year}} is now available.\n\n{{membership_url}}', 1, 1),
    ('logbook_renewal', 'Horse Logbook Renewal', 'general', 'Horse logbook registration for {{membership_year}}', '<h2>Horse logbook registration</h2><p>Hello {{first_name}},</p><p>Horse logbook registration for {{membership_year}} is now available.</p><p><a href="{{logbook_url}}">Register a horse logbook</a></p>', 'Hello {{first_name}},\n\nHorse logbook registration for {{membership_year}} is now available.\n\n{{logbook_url}}', 1, 1),
