...
<head>
    ...
    <style>
        :root{--green:#0f2d17;--light:#f5f7f3;--accent:#1f7c24}html{scroll-behavior:smooth}body{background:var(--light);color:#142018}.manual-shell{max-width:1000px}.manual-header,.manual-section{background:#fff;border:1px solid rgba(15,45,23,.09);border-radius:14px;box-shadow:0 10px 30px rgba(15,45,23,.07)}.manual-kicker{color:var(--accent);letter-spacing:.08em}.contents a{color:#165e1c}.manual-article{scroll-margin-top:1rem}.manual-article+.manual-article{border-top:1px solid #dfe8dd}.manual-body img{max-width:100%;height:auto}.manual-hidden{display:none!important}.manual-section-title{color:var(--green)}.manual-article-tool{display:inline-flex;align-items:center;justify-content:center;gap:.35rem;min-height:36px;padding:.35rem .7rem;border:1px solid rgba(20,97,24,.35);border-radius:999px;background:#fff;color:#146118;font-size:.82rem;font-weight:700;text-decoration:none;white-space:nowrap;box-shadow:0 4px 12px rgba(15,45,23,.1)}.manual-article-tool svg{width:14px;height:14px;fill:currentColor}.manual-article-tool:hover,.manual-article-tool:focus-visible{background:#146118;color:#fff}.manual-article-meta{margin-top:.4rem;font-size:.76rem;text-align:right}.manual-article-meta-line{display:flex;align-items:center;justify-content:flex-end;gap:.35rem;min-height:1.65rem;margin-top:.28rem}.manual-article-pills{display:flex;justify-content:flex-end;gap:.35rem}.manual-pill{display:inline-flex;align-items:center;justify-content:center;min-width:1.65rem;height:1.65rem;padding:0 .4rem;border-radius:999px;color:#fff;font-size:.76rem;font-weight:800;line-height:1}.manual-pill-visitor{background:#64748b}.manual-pill-user{background:#2563eb}.manual-pill-organiser{background:#7c3aed}.manual-pill-manager{background:#d97706}.manual-pill-admin{background:#dc2626}.manual-pill-superadmin{background:#374151}.manual-pill-user-manual{background:#0891b2}.manual-pill-admin-manual{background:#15803d}.manual-article-sort{color:#526052;font-weight:700}@media(max-width:767.98px){.manual-article-meta{display:none}}
                    ...
                    <div class="d-flex justify-content-between align-items-start gap-3">
                        ...
                        <?php if ($canEditHelpArticles): ?>
                            <div class="manual-article-actions flex-shrink-0">
                                ...
                                ?>
                                <div class="manual-article-meta" aria-label="Article access and manual information">
                                    <?php if ($audiencePill): ?><div class="manual-article-meta-line"><span class="manual-pill manual-pill-<?php echo h($audiencePill[2]); ?>" title="Available from: <?php echo h($audiencePill[1]); ?>" aria-label="Available from: <?php echo h($audiencePill[1]); ?>"><?php echo h($audiencePill[0]); ?></span></div><?php endif; ?>
                                    <div class="manual-article-meta-line manual-article-pills">
                                    ...
                                    <div class="manual-article-meta-line manual-article-sort">Sort: <?php echo (int)($article['display_order'] ?? 0); ?></div>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
