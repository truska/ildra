...
function weeklyRideNoticeContent(PDO $pdo, string $baseUrl): array
{
    ...
    if(!$rows)return ['html'=>'{{weekly_intro}}<h1 style="margin:24px 0 16px;color:#0c2a12;font-size:26px;line-height:1.2;">Next Ride or Event</h1><p>There are no upcoming events to include this week.</p>{{weekly_outro}}','text'=>"{{weekly_intro_text}}\n\nNext Ride or Event\n\nThere are no upcoming events to include this week.\n\n{{weekly_outro_text}}"];
