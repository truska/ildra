...
<div class="col-md-6"><div class="row g-2"><div class="col-md-4"><label class="form-label">Display order</label><input class="form-control form-control-sm" type="number" name="display_order" value="<?php echo (int)$article['display_order']; ?>"></div><div class="col-md-4 pt-4"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="to_be_created" id="to-be-created" value="1" <?php echo !empty($article['to_be_created'])?'checked':'';?>><label class="form-check-label" for="to-be-created">Auto-create</label></div></div><div class="col-md-4 pt-4"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="is_published" id="published" <?php echo !empty($article['is_published'])?'checked':'';?>><label class="form-check-label" for="published">Published</label></div></div></div></div>
