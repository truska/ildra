...
<div class="col-12"><label class="form-label fw-semibold">Instructions</label><textarea class="form-control wysiwyg-field" name="body_html" rows="12" required><?php echo h($article['body_html']); ?></textarea></div>
