...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $type = in_array($_POST['content_type'] ?? '', ['rich_text','membership_options','horse_logbook_information','ride_prices','awards_winners'], true) ? $_POST['content_type'] : 'rich_text';
