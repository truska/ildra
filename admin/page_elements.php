...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $type = in_array($_POST['content_type'] ?? '', ['rich_text','membership_options','horse_logbook_information','ride_prices','current_events_calendar','past_events_calendar','faqs','awards_winners'], true) ? $_POST['content_type'] : 'rich_text';
...
<div class="col-md-5"><label class="form-label">Section type</label><select class="form-select" name="content_type"><option value="rich_text" <?php echo ($record['content_type'] ?? 'rich_text') === 'rich_text' ? 'selected' : ''; ?>>Rich text</option><option value="membership_options" <?php echo ($record['content_type'] ?? 'rich_text') === 'membership_options' ? 'selected' : ''; ?>>Membership options (live data)</option><option value="horse_logbook_information" <?php echo ($record['content_type'] ?? 'rich_text') === 'horse_logbook_information' ? 'selected' : ''; ?>>Horse logbook information (live data)</option><option value="ride_prices" <?php echo ($record['content_type'] ?? 'rich_text') === 'ride_prices' ? 'selected' : ''; ?>>Ride prices (live data)</option><option value="current_events_calendar" <?php echo ($record['content_type'] ?? 'rich_text') === 'current_events_calendar' ? 'selected' : ''; ?>>Current events calendar (live data)</option><option value="past_events_calendar" <?php echo ($record['content_type'] ?? 'rich_text') === 'past_events_calendar' ? 'selected' : ''; ?>>Past events calendar (live data)</option><option value="faqs" <?php echo ($record['content_type'] ?? 'rich_text') === 'faqs' ? 'selected' : ''; ?>>FAQs (live data)</option><option value="awards_winners" <?php echo ($record['content_type'] ?? 'rich_text') === 'awards_winners' ? 'selected' : ''; ?>>Awards and past winners (live data)</option></select><div class="form-text">Live types show the current published details and prices from the database.</div></div>
