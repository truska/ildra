...
$articleColumns=[
 ...
 'to_be_created'=>['label'=>'To be created','sortable'=>true,'filter'=>'select','options'=>['1'=>'Yes','0'=>'No'],'form'=>$filterForm,'value'=>static fn(array $row):string=>!empty($row['to_be_created'])?'1':'0','sort_value'=>static fn(array $row):string=>!empty($row['to_be_created'])?'Yes':'No'],
];
