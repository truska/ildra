            ...
            <tbody>
                <?php foreach ($memberships as $membership): ?>
                    <tr>
                        ...
                        <td class="text-end"><?php if ($canEditMemberships): ?><a class="btn btn-sm btn-outline-secondary" href="members.php?edit=<?php echo (int)$membership['id']; ?>#edit-membership">Edit</a><?php endif; ?></td>
                    </tr>
                <?php endforeach; ?>
